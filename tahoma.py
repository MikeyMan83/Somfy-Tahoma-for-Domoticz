...
class Tahoma:
    def __init__(self):
        ...
        self.base_url = f"https://gateway-{pin}.local:{port}/enduser-mobile-web/1/enduserAPI"
        self.cookie = None
        ...
        self.pin = "2017-8871-5701"
        self.port = "8443"
        self.token = "62ecd0f3cdda9a49c2c1"
        self.headers = {
...
def register_listener(self):
    ...
    Headers = self.headers
    url = self.base_url + '/events/register'
...
def get_devices(self, Devices, firstFree):
    ...
    Headers = self.headersurl = self.base_url + '/setup/devices'
...
def get_events(self):
    ...
    Headers = self.headers
    url = self.base_url +self.listenerId+'/fetch'
